  ...
  async historicSync() {
    ...
    const body = `
      <div class="field">
        ...
        <input type="date" id="syncStartDate" value="${firstDay}" style="width:100%; padding:11px 16px; border:1px solid var(--border); border-radius:10px; background:var(--surface-2); color:var(--text-1)">
      </div>
      <div class="field" style="margin-top:14px">
        <label>Fecha de fin</label>
        <input type="date" id="syncEndDate" value="${today}" style="width:100%; padding:11px 16px; border:1px solid var(--border); border-radius:10px; background:var(--surface-2); color:var(--text-1)">
      </div>
