    ...
    for s in summaries:
        if granularity == "daily":
            ...
            full_row_data = {
                ...
                "schedule": "Partido" if is_split else ("Continuo" if s["schedule_type"] == "continuous" else ("Flexible" if s["schedule_type"] == "flexible" else "Sin Horario")),
                "punches_e1": entry_1,
                "punches_x1": exit_1,
                "punches_e2": entry_2,
                "punches_x2": exit_2,
            ...
            full_row_data = {
                ...
                "department": s["department"],
                "period": period_str,
                "schedule": "Partido" if s["schedule_type"] == "split" else ("Continuo" if s["schedule_type"] == "continuous" else ("Flexible" if s["schedule_type"] == "flexible" else "Sin Horario")),
